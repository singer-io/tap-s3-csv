...
class S3CompressedZipFile(S3CompressedFile):
    ...
    def get_properties(self):
        ...
        properties["tables"] = "[{\"table_name\": \"zip_data_has_jsonl_file\",\"search_prefix\": \"compressed_files_zip_data_has_jsonl_file\",\"search_pattern\": \"compressed_files_zip_data_has_jsonl_file\\\\/.*\\\\.zip\"}]"
        return properties
