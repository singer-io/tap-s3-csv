...
class TestConversion(unittest.TestCase):
    ...
    def test_generate_schema(self,mock_count_sample):
        ...
        expected_result = {'name': {'type': ['null', 'string']}, 'id': {'type': ['null', 'integer', 'string']}, 'marks': {'type': ['null', 'list.number', 'string']}, 'students': {'type': 'object', 'properties': {}}, 'created_at': {'anyOf': [{'type': ['null', 'string'], 'format': 'date-time'}, {'type': ['null', 'string']}]}, 'tota': {'type': 'array', 'items': ['null', 'string']}}
