...
class S3CompressedZipMixFiles(S3CompressedFile):
    ...
    def get_properties(self):
        ...
        properties["tables"] = "[{\"table_name\": \"zip_has_mix_files\",\"search_prefix\": \"compressed_files_zip_has_mix_files\",\"search_pattern\": \"compressed_files_zip_has_mix_files\\\\/.*\\\\.zip\"}]"
        return properties
